...
class Migration(migrations.Migration):
    ...
    replaces = [(b'student_reg', '0001_initial'), (b'student_reg', '0002_auto_20140904_0932'), (b'student_reg', '0003_auto_20140904_0938'), (b'student_reg', '0004_auto_20140904_1213'), (b'student_reg', '0005_auto_20140905_0548')]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='other',
            field=models.OneToOneField(to='student_reg.Person'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='student',
            name='emergency_info',
            field=models.ForeignKey(default='', to='student_reg.EmergencyContact'),
        ...
        migrations.AlterField(
            model_name='student',
            name='school_grade',
            field=models.CharField(max_length=5, choices=[(b'PK', b'Pre-K'), (b'KG', b'Kindergarten'), (b'1', b'1'), (b'2', b'2'), (b'3', b'3'), (b'4', b'4'), (b'5', b'5'), (b'6', b'6'), (b'7', b'7'), (b'8', b'8'), (b'9', b'9'), (b'10', b'10'), (b'11', b'11')]),
        ),
        migrations.AddField(
            model_name='emergencycontact',
            name='father',
            field=models.OneToOneField(related_name=b'+', default=0, to='student_reg.Person'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='emergencycontact',
        ...
        migrations.AlterField(
            model_name='student',
            name='school_grade',
            field=models.CharField(max_length=5, choices=[(b'PK', b'Pre-K'), (b'KG', b'Kindergarten'), (b'1', b'1'), (b'2', b'2'), (b'3', b'3'), (b'4', b'4'), (b'5', b'5'), (b'6', b'6'), (b'7', b'7'), (b'8', b'8'), (b'9', b'9'), (b'10', b'10'), (b'11', b'11'), (b'12', b'12')]),
        ),
    ]
